...
if __name__ == "__main__":
    ...
    if tuning and TUNING_MODE == "hpo":
        # your current path (kept unchanged)
        ...
        # 1) Run unbiased nested CV estimate (uses inner_search_best_hp -> cv_score_hp)
        ...
        # 2) Pick a consensus HP from the per-fold winners (most frequent)
